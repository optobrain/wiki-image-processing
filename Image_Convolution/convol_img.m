...
% This function is created to conduct image convolution on the input image
% Function Arguments:
% in_img: tested image (data size: (width image, length image, channel image)
% kernel_size: size of the convolution kernel (data size: integer)
